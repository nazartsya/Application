...
namespace EventManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251029190317_SeedEventTags")]
    partial class SeedEventTags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManagementSystem.Domain.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0a0e3f2-46e9-4dc8-83f3-1234567890ba"),
                            Name = "Technology"
                        },
                        new
                        {
                            Id = new Guid("b0a0e3f2-46e9-4dc8-83f3-1234567890bb"),
                            Name = "Art"
                        },
                        new
                        {
                            Id = new Guid("b0a0e3f2-46e9-4dc8-83f3-1234567890bc"),
                            Name = "Business"
                        },
                        new
                        {
                            Id = new Guid("b0a0e3f2-46e9-4dc8-83f3-1234567890bd"),
                            Name = "Music"
                        });
                });
            ...
            modelBuilder.Entity("EventTags", b =>
                {
                    ...
                    b.HasOne("EventManagementSystem.Domain.Entities.Tag", null)
                        .WithMany()
